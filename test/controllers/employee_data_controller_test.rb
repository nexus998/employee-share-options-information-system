...
class EmployeeDataControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create employee_datum' do
    assert_difference('EmployeeDatum.count') do
      post employee_data_path,
           params: { employee_datum: { employee_id: @employee_datum.employee_id, field_id: @employee_datum.field_id,
                                       value: @employee_datum.value } }
    end
  ...
  test 'should update employee_datum' do
    patch employee_datum_url(@employee_datum),
          params: { employee_datum: { employee_id: @employee_datum.employee_id, field_id: @employee_datum.field_id,
                                      value: @employee_datum.value } }
